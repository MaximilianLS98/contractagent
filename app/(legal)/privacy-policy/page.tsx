		...
		<div className='container mx-auto px-4 py-12'>
			<div className='max-w-4xl mx-auto'>
				...
				<div className='prose prose-slate max-w-none'>
					...
					<p>
						At LegalEdge ("we," "our," or "us"), we respect your privacy and are
					...
					<ul className='list-disc pl-6 mb-4'>
						<li>
							...
							number, billing information, and other information you provide when
							creating an account or using our services.
						</li>
						<li>
							<strong>Document Information:</strong> Content of legal documents you
							upload for analysis.
						</li>
						<li>
							<strong>Usage Information:</strong> Information about how you use our
							website and services, including IP address, browser type, device
					...
					<h2 className='text-2xl font-semibold mt-8 mb-4'>
						4. Document Security and Retention
					</h2>
					<p>
						All documents uploaded to our platform are encrypted in transit and at rest.
						We use industry-standard security measures to protect your data.
					</p>
					<p>
						By default, we do not permanently store your documents after analysis is
						complete. Documents are automatically deleted from our servers within 30
						days unless you specifically request longer retention.
					</p>
					...
					<ul className='list-disc pl-6 mb-4'>
						...
						<li>
							<strong>Legal Requirements:</strong> When required by law or in response
					...
					<p>To exercise these rights, please contact us at privacy@legalverifyai.com.</p>
					...
					<p>
						...
						secure your personal information from accidental loss and unauthorized
					...
					<p>
						...
						the country in which you reside. These countries may have data protection
						laws that are different from the laws of your country.
					</p>
					<p>
						We have taken appropriate safeguards to ensure that your personal
					...
					<p>
						...
						we have collected personal information from a child under 18, we will delete
						that information.
					</p>
